preferences {
	section("Internal Access"){
		input "matleds_ip", "text", title: "IP of Matleds service", required: false
		input "matleds_port", "text", title: "Port of Matleds service", required: false
	}
}
...
metadata {
	definition (name: "Ledstrip controller", namespace: "magimat", author: "Mathieu Girard") {
	        capability "Actuator"
			capability "Switch"
			capability "Sensor"
