...
metadata {
	...
	definition (name: "MimoLite Garage Door Controller (magi)", namespace: "smartthings", author: "Todd Wackford") {
	...
	tiles {
        standardTile("switch", "device.switch", width: 2, height: 2, canChangeIcon: true) {
			state "doorClosed", label: "Closed", action: "on", icon: "st.doors.garage.garage-closed", backgroundColor: "#e51048"
            state "doorOpen", label: "Open", action: "on", icon: "st.doors.garage.garage-open", backgroundColor: "#2baa17"
